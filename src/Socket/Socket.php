...
namespace DevBabuInd\NonBlockingPHP\Socket;

use DevBabuInd\NonBlockingPHP\Socket\Runners\Fsock;
use DevBabuInd\NonBlockingPHP\Socket\Runners\SocketConnect;
use DevBabuInd\NonBlockingPHP\Socket\Runners\StreamSocketClient;
...
class Socket {
    ...
    public function initRunner($runner) {
        ...
        if ($runner != '' && in_array($runner, array_keys($this->runners))) {
            ...
            $class = "DevBabuInd\NonBlockingPHP\Socket\Runners" . $runnerClass;
            $runnerObj = new $class();
    ...
    public function runBackgroundJob($url, $params, $httpAuth) {
        ...
        $runner = 'DevBabuInd\NonBlockingPHP\Socket\Runners' . $this->suitableRunner;
